...
def emoji_helper(selected_user,df):
    ...
    for message in df["Message"]:
        emojis.extend([c for c in message if c in list(filter(lambda x: x[1]["en"] == c, emojiList.items()))])
